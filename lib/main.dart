...
class _MyHomePageState extends State<MyHomePage> {
  ...
  bool _escolarizados = false;
  bool _vacinados = false;
  ...
  void Auxilio(){
    setState(() {
      ...
      if(_salary < (MINIMUM_SALARY*2) && _child <= 2 && _escolarizados == true && _vacinados == true){
        auxilio += MINIMUM_SALARY*1.5;
        _infoText = "Recebera um auxilio de ${auxilio}";
      }
      /*Estagio 2 do auxilio*/
      else if(_salary < MINIMUM_SALARY && _child <= 2 && _escolarizados == true && _vacinados == true){
        auxilio += MINIMUM_SALARY*2.5;
        _infoText = "Recebera um auxilio de ${auxilio}";
      }
      /*Estagio 3 do auxilio*/
      else if(_salary < (MINIMUM_SALARY*2) && _child >= 3 && _escolarizados == true && _vacinados == true){
            ...
            crossAxisAlignment: CrossAxisAlignment.stretch,
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text("Todos os filhos na escola", style: TextStyle(color: Colors.blue, fontSize: 20)),
                ),
                Switch(
                  value: _escolarizados,
                  onChanged: (value){
                    setState(() {
                      _escolarizados = value;
                    });
                  },
                ),
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 10, 0, 0),
                  child: Text("Todos os filhos vacinados", style: TextStyle(color: Colors.blue, fontSize: 20)),
                ),
                Switch(
                  value: _vacinados,
                  onChanged: (value){
